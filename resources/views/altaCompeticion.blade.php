    ...
    <section class="altaNoticia">
        <form method="POST" action="" id="altaNoticia" enctype="multipart/form-data">
            ...
            <div id="login" class="container">
                <h2 style="color: white;">AÑADIR COMPETICION</h2>
                <div class="form">
                    <div class="item">
                    ...
                    <div class="item">
                        <input type="text" id="titulo" placeholder="Título" name="titulo" value="{{ old('titulo') }}" ><br>
                        @error('titulo')
                    ...
                    <div class="item">
                        ...
                        <textarea placeholder="" name="descripcion" id="descripcion" rows="10" cols="25" class="comentario-textarea">{{ old('descripcion') }}</textarea><br>
                        @error('descripcion')
                        <span style="color: red;">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="item">
                        <input type="text" id="localizacion" placeholder="Localización" name="localizacion" value="{{ old('localizacion') }}" ><br>
                        @error('localizacion')
                        <span style="color: red;">{{ $message }}</span>
                        @enderror
                    </div><br>
