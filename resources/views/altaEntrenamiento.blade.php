                ...
                <div id="login" class="container">
                    ...
                    <div class="form">
                        ...
                        <div class="item">
                            ...
                            <textarea placeholder="Escribe el entrenamiento" name="entrenamiento" id="textoentreno" rows="10" cols="25" class="comentario-textarea">{{ old('entrenamiento') }}</textarea><br>
                            @error('entrenamiento')
                                <span style="color: red;">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="item">
                            <input type="date" id="dia" name="dia" value="{{ old('dia') }}" > <br>
                            @error('dia')
                                <span style="color: red;">{{ $message }}</span>
                            @enderror
                        </div>
