...
<!doctype html>
    ...
    @if(Auth::check())
        ...
        <div style="width: 50%;">
            <section class="altaNoticia">
                <form method="POST" action="{{route('MinimasR')}}" id="altaNoticia" enctype="multipart/form-data">
                    @csrf
            ...
            <div style="width: 90%; margin: 0 auto;">
                ...
                @else
                    @foreach($minimasRelevos as $tiempo)
                        @php
                        ...
                        <table class="table" style="background: #163b3d80; color:white; border-radius: 15px; margin-bottom: 20px;">
                            <tbody>
                                <tr style="border-radius: 15px;">
                                    <td style="background-color: transparent; color: white; border-radius: 15px; border-bottom: none; width: 40%; text-align: center; font-size: 1.2em;">
                                    ...
                                    <td style="background-color: transparent; color: white; border-radius: 15px; border-bottom: none; width: 20%; text-align: center; font-size: 1.2em; vertical-align: middle;" class="align-middle">{{ $tiempo->tiempo }}</td>
                                    <td style="background-color: transparent; color: white;border-radius: 15px; border-bottom: none; width: 20%; text-align: center; font-size: 1.2em; vertical-align: middle;" class="align-middle">{{ $tiempo->lugar }}</td>
                                    <td style="background-color: transparent; color: white;border-radius: 15px; border-bottom: none; width: 20%; text-align: center; font-size: 1.2em; vertical-align: middle;" class="align-middle">   {{ \Carbon\Carbon::createFromFormat('Y-m-d', $tiempo->fecha)->format('d/m/Y') }}</td>
        ...
        <div style="display: flex; justify-content: space-between; width: 100%;">
            <div style="width: 50%;">
                <section class="altaNoticia">
                    <form method="POST" action="{{route('MinimasRN')}}" id="altaNoticia" enctype="multipart/form-data">
                        @csrf
                        <div id="loginB" class="container">
                            <h2 style="color: white; text-align: center;">BUSCAR MINIMAS RELEVOS</h2>
                            <div class="form" style="display: flex; justify-content: space-between;">
    ...
    @if(Auth::check())
        ...
        <div style="width: 50%;">
            <section class="altaNoticia">
                <form method="POST" action="{{route('minimas')}}" id="altaNoticia" enctype="multipart/form-data">
                    @csrf
                    <div id="loginB" class="container">
                        ...
                        @foreach($resultadosFinales as $tiempo)
                            ...
                            @if($nadador)
                                <table class="table" style="background: #163b3d80; color:white; border-radius: 15px; margin-bottom: 20px;">
                                    <tbody>
                                        <tr style="border-radius: 15px;">
                                            <td style="background-color: transparent; color: white; border-radius: 15px; border-bottom: none; width: 40%; text-align: center; font-size: 1.2em; vertical-align: middle;" >{{ $nadador->nombre }} {{ $nadador->primer_apellido }} {{ $nadador->segundo_apellido }}</td>
                                            <td style="background-color: transparent; color: white; border-radius: 15px; border-bottom: none; width: 20%; text-align: center; font-size: 1.2em; vertical-align: middle;">{{ $tiempo->tiempo }}</td>
                                            <td style="background-color: transparent; color: white; border-radius: 15px; border-bottom: none; width: 20%; text-align: center; font-size: 1.2em; vertical-align: middle;">{{ $tiempo->lugar }}</td>
                                            <td style="background-color: transparent; color: white; border-radius: 15px; border-bottom: none; width: 20%; text-align: center; font-size: 1.2em; vertical-align: middle;">  {{ \Carbon\Carbon::createFromFormat('Y-m-d', $tiempo->fecha)->format('d/m/Y') }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            @endif
    ...
    @elseif (Auth::user()->tipo === 'Nadador')
            ...
            <div style="width: 50%;">
                <section class="altaNoticia">
                    <form method="POST" action="{{route('minimasN')}}" id="altaNoticia" enctype="multipart/form-data">
                        @csrf
                        <div id="loginB" class="container">
                            <h2 style="color: white; text-align: center;">BUSCAR MINIMAS INDIVIDUALES</h2>
                            <div class="form">
