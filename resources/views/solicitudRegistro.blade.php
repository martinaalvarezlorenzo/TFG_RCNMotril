<!doctype html>
    ...
    <body>
        ...
        <form action="{{route('register')}}" method="POST" id="altaUsuario" enctype="multipart/form-data">
            @csrf
            <div id="login">
                ...
                <div class="form">
                    ...
                    <div class="item">
                        <label for="foto">Foto nadador (Vertical)</label><br>
                ...
                <div class="container">
                    <a href="{{route('login')}}" class="btn btn-light btnSR" >Iniciar Sesión</a>
                </div>
            </div>
        </form><br>
